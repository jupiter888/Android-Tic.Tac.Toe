package com.example.dtracy.myapplication;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameGrid[1][0] = (Button) findViewById(R.id.button2);
        gameGrid[2][0] = (Button) findViewById(R.id.button3);
        gameGrid[0][1] = (Button) findViewById(R.id.button4);
        gameGrid[1][1] = (Button) findViewById(R.id.button5);
        gameGrid[2][1] = (Button) findViewById(R.id.button6);
        gameGrid[0][2] = (Button) findViewById(R.id.button7);
        gameGrid[1][2] = (Button) findViewById(R.id.button8);
        gameGrid[2][2] = (Button) findViewById(R.id.button9);
    }

    public void updateStatus(String text) {
        TextView tGS = (TextView) findViewById(R.id.textGameStatus);
        tGS.setText(text);
    }
